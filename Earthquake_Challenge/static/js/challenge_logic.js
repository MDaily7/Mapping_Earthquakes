...
//create a third tile layer for the map background
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // use d3.json to make a call to get the major earthquakes geoJSON data
  let majorQuakesURL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson";

  d3.json(majorQuakesURL).then(function(data) {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  // style for tectonic geojson data
  let tectonicStyle = {
    color: 'red', 
    weight: 2
  }
